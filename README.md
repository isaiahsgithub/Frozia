# Note: The scene order is Main Menu, SampleScene, Scene2, Scene3
# Additionally, on Scene2, 5 mobs will randomly spawn based on 15 preset locations. Every 5 seconds, the amount of mobs killed will respawn (e.g. if you killed 2/5 mobs after 5 seconds 2 will respawn).
# Zombies will randomly make their sound effect (to give it a more minecraft-like feature)
# The Ninja Girl and Cat NPC in the Town and Zombies will randomly move. They will not always move together.
